...
function createFakerSchema(schema) {
  ...
  switch (s.title) {
    ...
    case 'RemoteDetectionAlert':
      // this messes up definitions
      // s.properties.geometry = Geometry
      // sync version, async is `.resolve`.
      // This crashes with a call stack size exceded...
      //const resolvedSchema = JSONSchemaFaker.generate(s, Geometry)
